...
function agent(id: string, name: string, description: string): void {
  let a: AgentRow = { id: id, agentName: name, description: description, modelConfigId: "c1", promptId: "p1", enabled: true, updatedAt: "t" };
...
function seeded(): void {
  ...
  let m: ModelRow = { id: "m1", label: "Mistral Small", apiName: "mistral-small-latest", provider: "mistral", kind: "chat", dimensions: 0, enabled: true };
...
test("a child is described by its own row", () => {
  let a: AgentRow = { id: "a2", agentName: "scout", description: "searches the archive", modelConfigId: "c1", promptId: "p1", enabled: true, updatedAt: "t" };
...
test("a child with no description still says what it is", () => {
  let bare: AgentRow = { id: "a3", agentName: "scout", description: "", modelConfigId: "c1", promptId: "p1", enabled: true, updatedAt: "t" };
