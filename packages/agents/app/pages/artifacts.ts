...
// and /artifacts answered the chat home, which reads as the page having lost its
...
export class PageArtifacts extends LitElement {
  render() {
    return html`<agent-console .startView=${"library"}></agent-console>`;
  }
}
